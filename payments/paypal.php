    ...
    <div class="paystack-shell">
        <header class="paystack-header">
            <div class="paystack-brand">
                ...
                <div>
                    <h1 class="paystack-title mb-1">International Payment</h1>
                    <p class="paystack-subtitle mb-0">Pay with PayPal or Zelle</p>
                </div>
            </div>
        ...
        <div class="paystack-grid">
            <section class="paystack-form-card">
                <div class="paystack-form-header">
                    ...
                    <p class="text-muted mb-0">Select a method to continue.</p>
                </div>
...
function handleInternationalPayment(e) {
    ...
    if (method === 'paypal') {
        ...
        <div class="zelle-instructions mt-3 p-4 text-center">
            ...
            <div class="zelle-note mb-3">Include your name and payment purpose in the note.</div>
